MESSAGES = {
    'en': {
        ...
        'link_error': "⚠️ Sorry, I couldn't read that link. Please try describing the product instead.",
    ...
    'he': {
        ...
        'link_error': "⚠️ מצטער, לא הצלחתי לקרוא את הקישור. אנא נסה לתאר את המוצר במקום.",
