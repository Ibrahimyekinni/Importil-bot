MESSAGES = {
    'en': {
        ...
        'link_fetch_failed': "⚠️ I couldn't open that link. It may have expired or be region-restricted. Please send a clean product link or just type the product name/model directly.",
    ...
    'he': {
        ...
        'link_fetch_failed': "⚠️ לא הצלחתי לפתוח את הקישור. ייתכן שפג תוקפו או שמוגבל אזורית. אנא שלח קישור מוצר נקי או פשוט הקלד את שם המוצר/דגם ישירות.",
